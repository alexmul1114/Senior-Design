...
def main():
    ...
    if args.dataset.lower() == 'hrsid':
        ...
        train_patches_folder = os.path.join(args.dataset_path, 'yolo_2', 'train', 'images')
        val_patches_folder = os.path.join(args.dataset_path, 'yolo_2', 'val', 'images')
        test_patches_folder = os.path.join(args.dataset_path, 'yolo_2', 'test', 'images')
        train_labels_folder = os.path.join(args.dataset_path, 'yolo_2', 'train', 'labels')
        val_labels_folder = os.path.join(args.dataset_path, 'yolo_2', 'val', 'labels')
        test_labels_folder = os.path.join(args.dataset_path, 'yolo_2', 'test', 'labels')
        ...
        for split in ['train', 'val', 'test']:
            image_split_folder = os.path.join(args.dataset_path, 'yolo_2', split, 'images')
            label_split_folder = os.path.join(args.dataset_path, 'yolo_2', split, 'labels')
        ...
        yaml_info = {"path": os.path.join(args.dataset_path, "yolo_2"), "train": "train/images", 
                     "val": "val/images", "test": "test/images", "names": {0: "ship"}}
        with open(os.path.join(args.dataset_path, 'yolo_2', args.dataset.lower() + '.yaml'), 'w') as yaml_file:
