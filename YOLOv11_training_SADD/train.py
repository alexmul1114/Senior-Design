...
data_yaml = '/home/tjriz/Documents/Senior-Design/datasets/SADD/hust-rslab-SAR-aircraft-data.v2i.yolov11.resize640/data.yaml'  # Path to the updated data.yaml file
...
model.train(
    ...
    name='airplane_detection_resize640_newsplit', # Custom name for the experiment
